...
// разработчиков - это консоль разработчика прямо в браузере. 
...
// передавать их в другой ресторан. 
...
console.log(isOpen(restorantData.openNow)); //1) было console.log(isOpen(openNow)) меняем 
//на console.log(isOpen(restorantData.openNow));
